...
:: move this to other space
curl -O -s https://raw.githubusercontent.com/FelipeNasci/tools/main/windows/scripts/labs/labinfo01/assets/trmm-gticmmg-lab1-workstation-amd64.exe

whoami

pause

:: move trmm-gticmmg-lab1-workstation-amd64.exe %USERPROFILE%\Desktop

:: cd %USERPROFILE%\Desktop

:: trmm-gticmmg-lab1-workstation-amd64.exe
